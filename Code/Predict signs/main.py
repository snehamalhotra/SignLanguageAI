    ...
    while True:
        ...
        if results:
            for i in results:
                ...
                label4 = Label(f2, text="                            Indian Sign Language Detection System", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
                statusbar = Label(f1, text="                            Indian Sign Language Detection System", font=("arial", 8, "bold"),
                ...
                label4 = Label(f3, text="                            Indian Sign Language Detection System", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)

                # =========================Main Buttons=========================================

                btn2w2 = ttk.Button(f1, text="Detect Signs", command=pred_main)
                btn2w2.place(x=255, y=115, width=150, height=30)

                btn3w2 = ttk.Button(f1, text="Translate Speech to Signs", command=rr_main)
                ...
                label11 = Label(f4, text="     Indian Sign Language Detection System", font=("arial", 10, "bold"), bg="grey16",
                                fg="white")
                ...
                def swap4(frame):
                    frame.tkraise()
                    statusbar['text'] = '                            Indian Sign Language Detection System'
